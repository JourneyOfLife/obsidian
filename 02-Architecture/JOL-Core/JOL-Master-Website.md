...
1.  **Scope:** Focus *strictly* on the **front-facing website repository**. This includes:
    ...
    *   DevOps aspects related to the *frontend* codebase (CI/CD, deployment).
    *   Repository structure, documentation, and development workflows.
    *   Do *not* design the backend API, database schemas, mobile app code, or the internal logic of Bitrix24 itself within this *website* architecture plan, though API interaction points should be considered.
...
https://chat.qwen.ai/c/e27c77ff-42de-46ae-a56b-e691d2986ddd


# Architecture Document: `journey-of-life-master-website`
...
### 5.3 Routing & Multilingual Strategy
...
## 9. Compliance Considerations (GDPR)
...
*   **Integration Security:** Trust that the 1C-Bitrix/Bitrix24 backend handles sensitive data (user info, donations) securely according to GDPR. The frontend's role is secure communication *to* the backend.
